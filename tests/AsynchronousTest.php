...
class AsynchronousTest extends PHPUnit_Framework_TestCase
{
    ...
    {
        $ch1 = curl_init('http://slowwly.robertomurray.co.uk/delay/2000/url/http://www.google.com');
        curl_setopt($ch1, CURLOPT_RETURNTRANSFER, 1);
        $ch2 = curl_init('http://slowwly.robertomurray.co.uk/delay/2000/url/http://www.google.com');
